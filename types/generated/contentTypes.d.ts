...
export interface ApiCustomerCustomer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    name: Schema.Attribute.String;
    taxIdentificationNumber: Schema.Attribute.String;
    email: Schema.Attribute.Email;
...
export interface ApiDataChartDataChart extends Struct.CollectionTypeSchema {
  collectionName: 'data_charts';
  info: {
    singularName: 'data-chart';
    pluralName: 'data-charts';
...
export interface ApiKeyMetricKeyMetric extends Struct.CollectionTypeSchema {
  collectionName: 'key_metrics';
  info: {
    singularName: 'key-metric';
    pluralName: 'key-metrics';
  ...
  attributes: {
    ...
    versus: Schema.Attribute.String;
    growthIndicator: Schema.Attribute.Enumeration<
      ['negative', 'positive', 'neutral']
    >;
    previousPeriod: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::data-chart.data-chart': ApiDataChartDataChart;
      'api::global.global': ApiGlobalGlobal;
      'api::invoice.invoice': ApiInvoiceInvoice;
      'api::key-metric.key-metric': ApiKeyMetricKeyMetric;
